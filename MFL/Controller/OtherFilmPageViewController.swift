//
//  OtherFilmPageViewController.swift
//  MFL
//
...
class OtherFilmPageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        _currentFilm = FilmListViewController.currentFilm
        _currentFilmCategory = FilmListViewController.currentFilmCategory
        _currentPosterURL = FilmListViewController.currentPosterURL
        _currentFilmID = FilmListViewController.currentFilmID
        
        print("FUCKK", _currentFilm, _currentFilmCategory)
